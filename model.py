...
class Tournament(object):
    def __init__(self, raw_type, raw, date, name, players, matches, regions, id=None):
        '''
    ...
    @classmethod
    def from_scraper(cls, raw_type, scraper, player_alias_to_player_id_map, region_id):
